module.exports = {
    ...
    installInstructions: `To get this project set up and ready to go run the following commands:
    
    \`\`\`
    npm i
    \`\`\``,
    usageInfo: `1. Follow the Installation instructions as described above.
